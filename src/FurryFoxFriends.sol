...
abstract contract FurryFoxFriends is ERC721("FurryFoxFriends", "F3"), Ownable2Step {
    ...
    // @audit presaleMint does not initialize the alreadyMinted and alreadyUsedLead mapping so anyone can mint any number of times
    // @audit mint is external has no checks on the number of times anyone can mint
